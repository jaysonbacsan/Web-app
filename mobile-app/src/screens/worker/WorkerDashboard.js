...
export default function WorkerDashboard({ user, onLogout, navigation }) {
    ...
    const menuItems = [
        ...
        { 
            id: 'myApplications',  // NEW - ADD THIS
    ...
    const stats = [
        { label: 'Available Jobs', value: jobs.length, icon: '💼', color: colors.secondary },
        { label: 'Applied', value: 0, icon: '📝', color: colors.info },  // Updated - will track later
        { label: 'Completed', value: 0, icon: '✅', color: colors.verified },
        { label: 'Rating', value: user.rating || 'New', icon: '⭐', color: colors.warning }
    ];
            ...
            <View style={{ backgroundColor: colors.primary, padding: 20, paddingBottom: 30 }}>
                <View style={{ flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between' }}>
                    ...
                    <View style={{ flexDirection: 'row', alignItems: 'center' }}>
                        ...
                        <TouchableOpacity onPress={onLogout} style={{ backgroundColor: colors.danger, padding: 8, borderRadius: 8, marginLeft: 10 }}>
                    ...
                    jobs.slice(0, 5).map(job => (
                        <View key={job.id} style={{
                            ...
                            <View style={{ flex: 1 }}>
                                ...
                                <Text style={{ fontSize: 11, color: colors.info }}>Client: {job.client?.name || 'Unknown'}</Text>
                            </View>
                            <TouchableOpacity
                                style={{
